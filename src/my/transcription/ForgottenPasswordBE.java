...
// TODO: ResultSet closed error
     ...
     * from
     * @return the security question matching the username given if the username
     * is correct, or an empty string if it isn't.
     */
     ...
     * @param qAnswer security question answer that was pulled from the
     * Trainee's input
     * @return either an empty string if the security answer was incorrect, or
     * the trainee's password if it was correct
     */
